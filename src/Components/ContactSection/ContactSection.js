            ...
            <ContactTextContainer>
                ...
                <LinkContainer>
                    <ContactNavItemLeft>
                        ...
                        <Text>
                        <a href="https://www.linkedin.com/in/noel-alfaro333" target={"_blank"} rel="noreferrer">
                            LinkedIn
                        </a>
                        </Text>
                ...
                <LinkContainer>
                    <ContactNavItemLeft>
                        ...
                        <Text>
                        <a href="https://github.com/noelzzz" target={"_blank"} rel="noreferrer">
                            GitHub
                        </a>
                        </Text>
...
const ContactNavItemRight = styled.div`
    font-size: 28px;
    font-weight: 700;
    display: flex;
    width: 50%;
